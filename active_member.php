...
<body>
	<div class="new-wrap">
		...
		<div class="top-title">
			<p>
				<span class="icon-comm">积</span>
				<span class="top-t">积极分子</span>
			</p>
		</div>
<div id="container">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <span type="button" class="btn  addBtn">
                    <i class="icon-add"></i><a href="person_create.php?branch=<?php echo $branch?>&type=积极分子">新增</a>
                </span>
				</div>
            ...
            <div class="col-md-12">
                <table class="table" align="center">
                    ...
                    while ($rows = $result->fetch_array()) {
                        ...
                        <tr class="ttd">
                        <td>$index</td>
                        <td class='td-name'><a href = "person_detail.php?name={$rows['name']}&type=积极分子&branch={$branch}">{$rows['name']}</a></td>
