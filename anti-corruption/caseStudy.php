...
?>
    ...
    <div class="new-wrap">
        <div class="top-title">
            <p>
                <span class="icon-comm">案</span>
                <span class="top-t">案例学习</span>
            </p>
        </div>
            ...
            if ($authorityCode <= 1){
                ...
                <div class="addbtn">
                        <span type="button" class="btn btn-default addBtn">
                            <i class="icon-add"></i><a href="./submitItem.php?type=案例学习">新增</a>
                        </span>
            ...
            <div class="row memberTable new-martop">
                <div class="col-md-12">
                    <table class="table">
                        ...
                        $query = "select * from `anticorruption` WHERE `type` = '案例学习' ORDER BY `ID` DESC";
