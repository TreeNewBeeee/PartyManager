...
<div class="new-wrap">
    <div class="top-title">
        <p>
            <span class="icon-comm">购</span>
            <span class="top-t">小微采购</span>
        </p>
    </div>
            ...
            echo <<<PRINT
                <div class="addbtn">
                        <span type="button" class="btn btn-default addBtn">
                            <i class="icon-add"></i><a href="./submitItem.php?type=小微采购">新增</a>
                        </span>
        ...
        <div class="row memberTable new-martop">
            <div class="col-md-12">
                <table class="table">
                    ...
                    $query = "select * from `anticorruption` WHERE `type` = '小微采购' ORDER BY `ID` DESC";
