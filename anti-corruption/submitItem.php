...
<div class="new-wrap">
    <div class="top-title">
        <p>
            ...
            <span class="top-t">发布页</span>
        </p>
    </div>

    <div id="content">
        <form action="./uploadItem.php?type=<?php echo $_GET['type']?>" method="post" enctype="multipart/form-data" class="layui-form new-form clearfix">
