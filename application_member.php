...
<div id="container">
    ...
    <div id="content">
        ...
        <h3><i class="fa fa-child"></i>&nbsp;申请入党</h3>
        <hr>
        <div class="col-md-12">
            <div class="row">
                <?php
                ...
                <button type="button" class="btn btn-default">
                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><a href="person_create.php?branch=<?php echo $branch?>&type=申请入党">新增</a>
                </button>
            ...
            <div class="col-md-12">
                ...
                <table class="table table-condensed" align="center">
                    ...
                    while ($rows = $result->fetch_array()) {
                        ...
                        <tr>
                        <td>$index</td>
                        <td><a href = "person_detail.php?name={$rows['name']}&type=申请入党&branch={$branch}">{$rows['name']}</a></td>
