	...
	<div class="new-wrap">
		<div class="top-title">
			<p>
				...
				<span class="top-t">删除-支委会开展情况</span>
			</p>
		</div>
    <div id="container">
        <div id="content">
...
if (isset($_POST['year'])){
    ...
    $query = "SELECT * FROM `plans` WHERE `branch` = '".$branch."' AND `year` = '".$_POST['year']."' AND `month` = '".$_POST['month']."' AND `type` = '支委会'";
...
//    echo $_POST['year'];
//    echo $_POST['month'];
    $query = "DELETE FROM `plans` WHERE `branch` = '".$branch."' AND `year` = '".$_POST['year']."' AND `month` = '".$_POST['month']."' AND `type` = '支委会'";
    $conn->query($query);
    $conn->close();
