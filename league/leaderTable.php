            ...
            echo <<<PRINT
                <div class="row">
                    <div class="col-md-4 col-md-offset-1">
                        <a class="btn btn-default" href="leaderCreate.php?branch={$branch}" role="button">新增</a>
                        <a class="btn btn-default" href="leaderDelete.php?branch={$branch}" role="button">删除</a>
