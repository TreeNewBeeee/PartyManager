...
<div id="container">
    ...
    <div id="content">
        <form action="uploadFixedMission.php" method="post" enctype="multipart/form-data">
            <h2><i class="fa fa-print"></i>&nbsp;定期任务-发布页</h2>
            <br>
            <hr>
            <br>
            <div class="row">
            ...
            <!--<div class="row">
                <div class="col-xs-4">
                    是否附件：是<input type="radio" name="fj"value="是">
                    否<input type="radio" name="fj"value="否">
                </div>
            </div>-->
            <br>
