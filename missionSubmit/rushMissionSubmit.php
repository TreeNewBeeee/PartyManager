...
<body>
	...
	<div class="new-wrap">
		<div class="top-title">
			<p>
				<span class="icon-comm">抢</span>
				<span class="top-t">抢接任务-发布页</span>
			</p>
		</div>

    <div id="content">
        <form action="uploadRushMission.php" method="post" enctype="multipart/form-data"  class="layui-form new-form clearfix">
        	<div class="d-info clearfix">
				...
				<div class="fo-item">
						<label for="" class="layui-form-label">任务个数</label>
					<div class="layui-input-inline">
						<input type="text" class="layui-input inp-date" name="num">
					</div>
				</div>
				 <div class="fo-item">
