	...
	<div class="new-wrap">
		<div class="top-title">
			<p>
				...
				<span class="top-t">亮点工作-发布页</span>
			</p>
		</div>

    <div id="content">
        <form action="uploadShinningMission.php" method="post" enctype="multipart/form-data"  class="layui-form new-form clearfix">
        	<div class="d-info clearfix">
				...
				<div class="fo-item">
						<label for="" class="layui-form-label">完成时期</label>
					<div class="layui-input-inline">
            ...
            <div>
                <input type="text" name="branch" hidden="hidden" value="<?php echo $branch?>">
            </div>
           </div>
               <div class="info-sub">
