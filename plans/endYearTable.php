...
?>
	...
	<div class="new-wrap">
			...
			<p>
				...
				<span class="top-t">年终述职-<?php echo $branch?></span>
			</p>
		</div>
            ...
            if ($row['branch'] == $branch){
                ...
                <div class="addbtn">
                        <span type="button" class="btn btn-default addBtn">
                            <i class="icon-add"></i><a href="endYearCreate.php?branch={$branch}" role="button">新增</a>
                        </span>
                         <span type="button" class="btn btn-default addBtn">
                            <i class="icon-add icon-dele"></i><a  href="endYearDelete.php?branch={$branch}" role="button">删除</a>
                        </span>
               </div>
