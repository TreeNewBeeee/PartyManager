	...
	<div class="new-wrap">
		<div class="top-title">
			<p>
				...
				<span class="top-t">删除月底总结-<?php echo $branch?></span>
			</p>
		</div>
    <div id="container">
       <div id="content">
...
if (isset($_POST['year'])){
    ...
    $query = "SELECT * FROM `plans` WHERE `branch` = '".$branch."' AND `year` = '".$_POST['year']."' AND `month` = '".$_POST['month']."' AND `type` = '月底总结'";
...
//    echo $_POST['year'];
//    echo $_POST['month'];
    $query = "DELETE FROM `plans` WHERE `branch` = '".$branch."' AND `year` = '".$_POST['year']."' AND `month` = '".$_POST['month']."' AND `type` = '月底总结'";
    $conn->query($query);
    $conn->close();
    ...
    echo <<<JUMP
            <script language="JavaScript">
                   alert("删除成功");
                   self.location='monthPlanTable.php?branch={$branch}';
            </script>
JUMP;
