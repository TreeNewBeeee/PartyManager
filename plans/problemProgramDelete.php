    ...
    <div class="new-wrap">
        <div class="top-title">
            <p>
                ...
                <span class="top-t">删除问题导向性项目-<?php echo $branch ?></span>
            </p>
        </div>
        <div id="container">
            <div id="content">
...
if (isset($_POST['year'])) {
    ...
    $query = "SELECT * FROM `plans` WHERE `branch` = '" . $branch . "' AND `year` = '" . $_POST['year'] . "' AND `month` = '" . $_POST['month'] . "' AND `type` = '问题导向性项目'";
...
//    echo $_POST['year'];
//    echo $_POST['month'];
    $query = "DELETE FROM `plans` WHERE `branch` = '" . $branch . "' AND `year` = '" . $_POST['year'] . "' AND `month` = '" . $_POST['month'] . "' AND `type` = '问题导向性项目'";
    $conn->query($query);
    $conn->close();
